...
SECRET_KEY = '-#8_ej3bqrl+(_*+_f6np9s@01&vy#_a!3y5deq_w5)w&0-pq7'
...
ROOT_URLCONF = 'wechooser.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'wechooser.wsgi.application'
...
TEMPLATE_DIRS = (
    ...
    os.path.join(BASE_DIR, 'customize/templates'),
)
