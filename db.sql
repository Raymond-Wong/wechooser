...
--
-- Table structure for table `customize_subscribe_record`
--

DROP TABLE IF EXISTS `customize_subscribe_record`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `customize_subscribe_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `date` date NOT NULL,
...
DROP TABLE IF EXISTS `customize_task`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `duiba_alarm`
--

DROP TABLE IF EXISTS `duiba_alarm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `duiba_alarm` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  ...
  CONSTRAINT `user_id_refs_id_1db71767` FOREIGN KEY (`user_id`) REFERENCES `wechat_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
